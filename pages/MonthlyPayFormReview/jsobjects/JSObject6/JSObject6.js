export default {
 async toBase64(url) {
    ...
    const reviewedBy = (appsmith && appsmith.store && appsmith.store.user && appsmith.store.user.username) ? appsmith.store.user.username : "";
    ...
    doc.text(`Date: ${reviewedAt}`, 115, footerY + 6);
		 ...
		 doc.text(`Rreated by: ${createdBy}`, 15, footerY);
